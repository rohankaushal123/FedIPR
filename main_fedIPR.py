    ...
    def __init__(self, args):
        ...
        if args.backdoor_indis:
            if args.dataset == 'cifar10':
                ...
                self.wm_data, self.wm_dict = prepare_wm_new(self.data_root + 'trigger/cifar10/', self.num_back, self.num_trigger)
            if args.dataset == 'cifar100':
                self.wm_data, self.wm_dict = prepare_wm_indistribution(self.data_root + 'trigger/cifar100/', self.num_back, self.num_trigger)
        else:
            self.wm_data, self.wm_dict = prepare_wm(self.data_root + 'trigger/pics', self.num_back)
